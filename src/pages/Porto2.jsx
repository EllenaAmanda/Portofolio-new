  ...
  return (
    <div>
        ...
        <h2 className='font-[myFont] text-center text-3xl mb-[8%] '>Graphic Design</h2>
          ...
          <div className="border border-neutral-200 h-80  overflow-x-auto overflow-y-hidden flex snap-x snap-mandatory rounded-md space-x-4">
              {first.map((url, index) => (
            ...
            <div className="border border-neutral-200 h-80 w-fit overflow-x-auto overflow-y-hidden flex snap-x snap-mandatory rounded-md space-x-4">
